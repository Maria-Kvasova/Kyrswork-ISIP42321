...
SECRET_KEY = 'django-insecure-zqkc6=ua$$%k&rtjydkgi$a62ukp@0kshi=-^^&n%g_%xekbgi'
...
# 📷 MEDIA FILES (ФОТО МАСТЕРОВ) — ДОБАВЛЕНО В КОНЕЦ
MEDIA_URL = '/media/'
...
DEFAULT_FROM_EMAIL = 'Maria Beauty <noreply@mariabeauty.ru>'